...
export async function createMagicLinkToken(phone: string): Promise<{ token: string; url: string }> {
...
export async function verifyMagicLinkToken(token: string, phone: string): Promise<boolean> {
